...
import { JwtAuthGuard, JwtPayload, TopupStatus } from '@app/common';
...
export class TopupController {
  ...
  async verifyTopup(
    ...
    try {
      ...
      const redirectByResult: Record<TopupStatus, string> = {
        [TopupStatus.PAID]: 'success',
        [TopupStatus.CANCELLED]: 'cancelled',
